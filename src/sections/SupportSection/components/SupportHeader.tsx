...
export const SupportHeader = () => {
    return (
      <ScrollReveal className="box-border caret-transparent gap-x-10 grid text-[10px] grid-cols-none leading-[11.5px] outline-neutral-900 outline-[3px] gap-y-10 no-underline md:gap-x-[26.6667px] md:text-[6.66667px] md:grid-cols-[auto_650.667px] md:leading-[7.66667px] md:gap-y-[26.6667px]">
