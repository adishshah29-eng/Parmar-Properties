...
export const BlogHeader = () => {
  return (
    <ScrollReveal className="items-center box-border caret-transparent gap-x-5 flex text-[10px] justify-between leading-[11.5px] outline-neutral-900 outline-[3px] no-underline md:text-[6.66667px] md:leading-[7.66667px]">
      <div className="box-border caret-transparent text-3xl font-medium tracking-[-0.3px] leading-[34.5px] outline-neutral-900 outline-[3px] no-underline md:text-5xl md:tracking-[-1.92px] md:leading-[55.2px]">
        From the Blog
      </div>
      <a
        href="/blog"
        className="box-border caret-transparent text-base font-medium leading-6 outline-neutral-900 outline-[3px] no-underline md:text-xs md:leading-[16.8px]"
      >
        View All
      </a>
    </ScrollReveal>
