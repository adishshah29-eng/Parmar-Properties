    ...
    <section className="relative flex items-center justify-center text-white h-[400px] md:h-[600px]">
      ...
      <div className="relative z-10 w-full max-w-[1920px] mx-auto px-6 md:px-16 text-center">
        ...
        <ScrollReveal delay={300} className="mt-8 md:mt-[30px] flex items-center justify-center gap-4">
          ...
          <div>
            <a
              href={`https://wa.me/${cta.whatsapp.phone}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center bg-[#25D366] text-white px-6 py-3.5 md:px-5 md:py-3 text-base md:text-sm font-medium leading-6 rounded-[100px] transition-transform hover:scale-105 shadow-md gap-2"
